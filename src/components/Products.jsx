...
const brushProducts = [
  {
    ...
    specs: [
      { label: 'Width', value: '12"', sub: 'Full-coverage stroke' },
      { label: 'Jets', value: '2', sub: 'Pencil jets' },
      { label: 'Thread', value: 'Euro', sub: 'Euro thread fitting' },
      { label: 'Type', value: 'Hybrid', sub: 'Fan bristles + jets' },
    ],
    features: [
      '12" wide — covers more glass per stroke',
      '2 pencil jets for targeted, precise rinsing',
      'Euro thread fitting — compatible with GLAER poles',
      'Fan bristles agitate glass in a single pass',
